...
- Écrire des tests de composants avec les bonnes queries
...
| 10:30-11:30 | Snapshot testing : quand utiliser, quand éviter, inline snapshots | VS Code |
...
- La hiérarchie des queries (getByRole > getByText > getByTestId)
- Un test qui echoue quand on utilise getByTestId alors que getByRole suffit
- La différence entre un bon et un mauvais snapshot (petit composant vs page entière)
